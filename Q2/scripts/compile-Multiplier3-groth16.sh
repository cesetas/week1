...
snarkjs groth16 setup Multiplier3/Multiplier3.r1cs powersOfTau28_hez_final_10.ptau Multiplier3/circuit_0001.zkey
...
snarkjs zkey export verificationkey Multiplier3/circuit_final1.zkey Multiplier3/verification_key1.json

# generate solidity contract
snarkjs zkey export solidityverifier Multiplier3/circuit_final1.zkey ../Multiplier3Verifier.sol
